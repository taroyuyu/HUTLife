...
+(instancetype)findViewController
{
    ...
    [[viewController tabBarItem] setImage:[UIImage imageNamed:@"ic_tabbar_find"]];
    [[viewController tabBarItem] setSelectedImage:[UIImage imageNamed:@"ic_tabbar_find_selected"]];
